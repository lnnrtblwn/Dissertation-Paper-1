...
than the elastic because instead of having two penalties that both shrink the parameters towards zero, we propose a weighting scheme that employs the following objective function:



The first penalty is familiar $L_2$-norm that conducts continuous shrinkage. The second 
